          ...
          <div className="flex gap-2 shrink-0">
            {onSyncOneDrive && (
              <button
                ...
                disabled={isSyncing}
                className={`bg-white hover:bg-slate-50 text-slate-800 border border-slate-200 px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2 transition-colors duration-150 shadow-2xs cursor-pointer active:scale-[0.99] ${isSyncing ? 'opacity-70 cursor-wait' : ''}`}
                id="btn-sync-onedrive-incidents"
              >
            ...
            <button
              ...
              className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-1.5 transition-colors duration-150 cursor-pointer shrink-0"
              id="btn-reportar-incidents"
            >
              <Plus size={16} />
              <span>Reportar</span>
            </button>
                ...
                {userProfile?.isAdmin && (
                  <div className="bg-surface-container-low p-4 rounded-xl border border-outline/20 space-y-2">
                    ...
                    {selectedIncident.reportedBy ? (
                      ...
                      <p className="text-xs text-on-surface-variant italic">Cargado por Personal del Edificio (Autorizado)</p>
                    )}
                  </div>
                )}
