                ...
                <div className="flex flex-col space-y-2">
                  ...
                  {userProfile && (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-3.5 bg-red-50 hover:bg-red-100 text-[#7a172c] border border-red-200/60 hover:border-red-300 rounded-xl text-xs font-bold transition-all shadow-3xs cursor-pointer text-left animate-fade-in"
                    ...
                    >
                      ...
                      <span className="text-[10px] text-red-700/80 font-medium">Salir del sistema</span>
                    </button>
                  )}
                </div>
              </div>
